...
public class PullToRefreshListView extends
	...
	public void addHeaderView(View view) {
		if (mListViewExtrasEnabled) {
			...
			// Create Loading Views ready for use later
			FrameLayout frame = new FrameLayout(getContext());
			frame.removeView(mHeaderLoadingView);
			view.setVisibility(View.VISIBLE);
			// view.setLayoutParams(new LayoutParams(
			// android.view.ViewGroup.LayoutParams.MATCH_PARENT,
			// android.view.ViewGroup.LayoutParams.WRAP_CONTENT));
			mRefreshableView.removeHeaderView(mHeaderLoadingView);
			mRefreshableView.addHeaderView(view);
	...
	public void setDividerHeight(int height){
		...
		mRefreshableView.invalidate();
	}

	public int getDividerHeight(){
		return mRefreshableView.getDividerHeight();
	}
}
