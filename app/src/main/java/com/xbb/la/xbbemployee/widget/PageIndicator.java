package com.xbb.la.xbbemployee.widget;
...
public class PageIndicator extends View implements ViewPager.OnPageChangeListener {
    ...
    public PageIndicator(Context context, AttributeSet attrs) {
        ...
        final int defaultSelectedColor = getResources().getColor(R.color.default_page_indicator_selected_color);

        // Retrieve styles attributes
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.PageIndicator);

        setFades(a.getBoolean(R.styleable.PageIndicator_fades, defaultFades));
        setSelectedColor(a.getColor(R.styleable.PageIndicator_selectedColor, defaultSelectedColor));
        setFadeDelay(a.getInteger(R.styleable.PageIndicator_fadeDelay, defaultFadeDelay));
        setFadeLength(a.getInteger(R.styleable.PageIndicator_fadeLength, defaultFadeLength));
