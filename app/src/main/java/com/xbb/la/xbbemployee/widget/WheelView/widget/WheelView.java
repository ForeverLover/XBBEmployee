...
package com.xbb.la.xbbemployee.widget.WheelView.widget;
...
public class WheelView extends View {
    ...
    // Wheel drawables
    private int wheelBackground = R.drawable.reinfo_gray;
    private int wheelForeground = R.drawable.reinfo_gray;
