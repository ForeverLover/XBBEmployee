...
public class TitleActivity extends BaseActivity {
    ...
    private TextView txtRight;// title文字
   ...
   /* private Button btnLeft;// 左边按钮
    ...
    private void initTitleView() {
        ...
        txtTitle = (TextView) vTitle.findViewById(R.id.title_center_txt);
        imgLeft = (ImageView) vTitle.findViewById(R.id.title_left_img);
//        txtLeft = (Button) vTitle.findViewById(R.id.title_left_text);
        imgRight = (ImageView) vTitle.findViewById(R.id.title_right_img);
//        txtRight = (Button) vTitle.findViewById(R.id.title_right_text);
