 ...
 * 项目:XBBEmployee
 * 作者：Hi-Templar
 * 创建时间：2015/12/4 11:56
 * 描述：${TO_DO}
 */
public class SlideBaseActivity extends SlidingActivity implements View.OnClickListener, XRequestCallBack {
    ...
    public void exitSystem() {
        if ((System.currentTimeMillis() - exitTime) > 2000) {
            ...
            application.exitSystem(SlideBaseActivity.this);
