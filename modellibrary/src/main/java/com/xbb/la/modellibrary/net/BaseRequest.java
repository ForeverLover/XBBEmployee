...
public class BaseRequest {
    ...
    protected static void request(XRequestCallBack XRequestCallBack, int taskId, String doUrl,
        ...
        XHttpRequest xHttpRequest = new XHttpRequest(taskId, XRequestCallBack, Constant.Url.URL_API + doUrl,flag);
        xHttpRequest.requestPost(requestParams);
    }

    protected static void requestByAbsUrl(XRequestCallBack XRequestCallBack, int taskId, String doUrl,
                                  RequestParams requestParams,String flag) {
        XHttpRequest xHttpRequest = new XHttpRequest(taskId, XRequestCallBack, doUrl,flag);
        xHttpRequest.requestPost(requestParams);
    }
    ...
    protected static void requestAfterSignedByAbsUrl(XRequestCallBack XRequestCallBack, int taskId, String doUrl,
                                             Map<String, String> map,String flag) {
        XHttpRequest xHttpRequest = new XHttpRequest(taskId, XRequestCallBack, doUrl,flag);
        RequestParams params = new RequestParams();
        params.addBodyParameter("sign", StringUtil.getMD5(StringUtil.getSignedParams(map)));
    ...
    protected static void requestByGet(XRequestCallBack XRequestCallBack, int taskId, String doUrl,
                                       RequestParams requestParams,String flag) {
        Log.v("Tag", "url:" + Constant.Url.URL_API + doUrl);
        XHttpRequest xHttpRequest = new XHttpRequest(taskId, XRequestCallBack, Constant.Url.URL_API + doUrl,flag);
